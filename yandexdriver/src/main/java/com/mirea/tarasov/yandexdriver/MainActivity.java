...
import com.mirea.tarasov.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String MAPKIT_API_KEY = "8354c243-1105-4420-9785-e1b796e9c75f";
        MapKitFactory.setApiKey(MAPKIT_API_KEY);
        MapKitFactory.initialize(this);
        SearchFactory.initialize(this);
        com.mirea.tarasov.yandexdriver.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void showMarkerInfo() {
        Toast.makeText(getApplicationContext(), "Ресторан The Bull" +
